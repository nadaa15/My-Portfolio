          ...
          <div className="grid lg:grid-cols-2 place-items-center gap-8">
            ...
            >
              <motion.p
                ...
                className="text-gray-200 md:text-5xl text-4xl mb-4"
              >
                Hi, I AM <br />{" "}
                <span className="font-bold text-purple-500 text-3xl md:text-5xl">
                  <TypeAnimation
              ...
              >
                ...
                <div className="flex gap-6 flex-row text-xl md:text-2xl text-purple-400 z-20">
                  <motion.a
